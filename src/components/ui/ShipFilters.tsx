...
const ShipFilters: React.FC<ShipFiltersProps> = ({ selectedTypes, setSelectedTypes, selectedRarity, setSelectedRarity, selectedNationality, setSelectedNationality }) => {
